...
/* harmony import */ var electron_squirrel_startup__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! electron-squirrel-startup */ "./node_modules/electron-squirrel-startup/index.js");
...
const __filename = (0,url__WEBPACK_IMPORTED_MODULE_2__.fileURLToPath)("file:///Users/danielkang/Development/interviewcheat/app/src/main/index.js");
const __dirname = path__WEBPACK_IMPORTED_MODULE_1__.dirname(__filename);

// Determine app root directory
const appDir = path__WEBPACK_IMPORTED_MODULE_1__.resolve(__dirname, '..', '..');
...
const bundledHTMLPath = path__WEBPACK_IMPORTED_MODULE_1__.join(appDir, 'dist', 'index.html');
console.log('Bundled HTML path:', bundledHTMLPath);

// Handle creating/removing shortcuts on Windows when installing/uninstalling.
if (electron_squirrel_startup__WEBPACK_IMPORTED_MODULE_3__) {
...
const createWindow = () => {
  ...
  mainWindow = new electron__WEBPACK_IMPORTED_MODULE_0__.BrowserWindow({
    ...
    // Set background color to match React app
    webPreferences: {
      nodeIntegration: false,
      contextIsolation: true,
      preload: path__WEBPACK_IMPORTED_MODULE_1__.join(__dirname, 'preload.cjs'),
      devTools: true
    }
  });

  // Try to load the bundled file
  if (fs__WEBPACK_IMPORTED_MODULE_4__.existsSync(bundledHTMLPath)) {
    console.log('Loading bundled React app from:', bundledHTMLPath);
    mainWindow.loadFile(bundledHTMLPath).then(() => console.log('Successfully loaded bundled React app')).catch(err => console.error('Failed to load bundled React app:', err));
  } else {
